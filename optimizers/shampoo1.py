...
from optimizers.matrix_functions import ComputePower
import numpy as np
import torch
...
#        print("")
        ...
        # avoid very slow CPU fallback paths in qtensor ops.
        ...
        if rank <= 1:
            ...
            eps = self.matrix_eps
            self.statistics = [QTensorDiagReal(eps * torch.eye(s[0], device=device), bits=effective_bits, 
